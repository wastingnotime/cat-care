...
import type { TriageAssessment } from "../lib/contracts";

export default function Triage() {
  const [triage, { refetch }] = createResource(() => api<TriageAssessment[]>("triage"));
  ...
  return <Shell><header class="page-heading"><p class="eyebrow">Care triage</p><h1>Veterinarian review</h1><p>AI urgency is provisional. It helps organize review and is not a diagnosis.</p></header>
