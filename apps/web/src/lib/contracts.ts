...
export type Workspace = "owner"|"veterinarian";
export type Session = { user:{id:string;name:string;email:string;mode:Workspace;roles:Workspace[]}; cats:CatAccount[]; active_cat_id:string };
