...
from mrl_simulation_runtime.scenario import (
    ...
    ObservatoryEdge,
    ObservatoryNode as RuntimeObservatoryNode,
    Scenario,
)
...
NODE_DOMAINS = {
    ...
    "review-care": "care-records",
    "review-notes": "care-records",
    "review-profile": "cat-profile",
    "triage-care": "care-triage",
    "review-triage-queue": "care-triage",
    "request-triage-information": "care-triage",
    "review-triage": "care-triage",
    "define-triage-follow-up": "care-triage",
    "manage-responsibility": "care-planning",
    "manage-cat-profile": "cat-profile",
    "record-care": "care-records",
    "deliver-notification": "notifications",
    "manage-data": "data-stewardship",
    "profile-adapter": "cat-profile",
    "notification-adapter": "notifications",
    "triage-adapter": "care-triage",
    "recurrence-adapter": "care-planning",
    "cat-profile": "cat-profile",
    "triage-assessment": "care-triage",
    "notification": "notifications",
    "data-lifecycle": "data-stewardship",
    "care-event": "care-records",
    "note": "care-records",
    "responsibility": "care-planning",
    "status": "care-status",
    "timeline": "care-records",
}


def cat_care_node(node_id: str, label: str, kind: str, layer: str) -> RuntimeObservatoryNode:
    return RuntimeObservatoryNode(
        node_id,
        label,
        kind,
        layer,
        realm="cat-care",
        domain=NODE_DOMAINS.get(node_id),
    )
...
def create_simulation() -> Scenario:
    ...
    return Scenario(
        ...
        observatory_nodes=[
            ...
            cat_care_node("review-care", "Review care events", "use_case", "use_cases"),
            cat_care_node("review-notes", "Review notes", "use_case", "use_cases"),
            cat_care_node("review-profile", "Review cat profile", "use_case", "use_cases"),
            cat_care_node("triage-care", "Request care triage", "use_case", "use_cases"),
            cat_care_node("review-triage-queue", "Review triage queue", "use_case", "use_cases"),
            cat_care_node("request-triage-information", "Request more information", "use_case", "use_cases"),
            cat_care_node("review-triage", "Review care triage", "use_case", "use_cases"),
            cat_care_node("define-triage-follow-up", "Define triage follow-up", "use_case", "use_cases"),
            cat_care_node("manage-responsibility", "Manage responsibility", "use_case", "use_cases"),
            cat_care_node("manage-cat-profile", "Edit cat profile", "use_case", "use_cases"),
            cat_care_node("record-care", "Record care history", "use_case", "use_cases"),
            cat_care_node("deliver-notification", "Record notification", "use_case", "use_cases"),
            cat_care_node("manage-data", "Manage owner data", "use_case", "use_cases"),
            cat_care_node("profile-adapter", "Profile gateway", "outbound_adapter", "external_providers"),
            cat_care_node("notification-adapter", "Notification gateway", "outbound_adapter", "external_providers"),
            cat_care_node("triage-adapter", "Triage service", "outbound_adapter", "external_providers"),
            cat_care_node("recurrence-adapter", "Recurrence resolver", "outbound_adapter", "external_providers"),
            cat_care_node("cat-profile", "Cat profile", "aggregate", "domain"),
            cat_care_node("triage-assessment", "Triage assessment", "entity", "domain"),
            cat_care_node("notification", "Notification", "aggregate", "domain"),
            cat_care_node("data-lifecycle", "Data lifecycle", "aggregate", "domain"),
            cat_care_node("care-event", "Care event", "entity", "domain"),
            cat_care_node("note", "Note", "entity", "domain"),
            cat_care_node("responsibility", "Responsibility", "aggregate", "domain"),
            cat_care_node("status", "Calm status", "projection", "projections"),
