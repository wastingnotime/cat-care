...
def create_simulation() -> Scenario:
    ...
    return Scenario(
        ...
        observatory_nodes=[
            ...
            ObservatoryNode("profile-adapter", "Profile gateway", "outbound_adapter", "outbound_adapters"),
            ObservatoryNode("notification-adapter", "Notification gateway", "outbound_adapter", "outbound_adapters"),
            ObservatoryNode("triage-adapter", "Triage service", "outbound_adapter", "outbound_adapters"),
            ObservatoryNode("recurrence-adapter", "Recurrence resolver", "outbound_adapter", "outbound_adapters"),
